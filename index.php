                                    ...
                                    <div class="as-producttile large-4 small-6 group-1">
                                        ...
                                        <div class="as-producttile-info" style="min-height: 168px;">
                                                ...
                                                <div class="as-producttile-title">
                                                    <h3 class="as-producttile-name">
                                                        <p class="as-producttile-tilelink">
                                                            <span data-ase-truncate="2">Nombre del producto seleccionado del carrito del ejercicio</span>
                                                        </p>
                                            ...
                                            <form action="./detail.php" method="get">
                                                ...
                                                <input type="hidden" name="title" value="Nombre del producto seleccionado del carrito del ejercicio">
